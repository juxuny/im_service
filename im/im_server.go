...
func StartHttpServer(addr string) {
	http.HandleFunc("/auth/token", LoginHandler)
...
func initLog() {
	...
	log.Infof("check config")
	log.SetReportCaller(config.log_caller)
	log.Infof("setReportCaller")
...
func main() {
	...
	log.Infof("before initLog")

	initLog()
	log.Infof("after initLog")
